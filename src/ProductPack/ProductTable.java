...
public class ProductTable extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        NewProduct nu = new NewProduct((Frame) this.getParent(), true);
        nu.setVisible(true);
        model.updateData();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (jTable1.getSelectedRow() >= 0) {
            NewProduct nu = new NewProduct((Frame) this.getParent(), true, model.getSelectedEntity(jTable1.getSelectedRow()));
            nu.setVisible(true);
            model.updateData();
            ((AbstractTableModel) jTable1.getModel()).fireTableDataChanged();
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        if (jTable1.getSelectedRow() >= 0) {
            c.deleteProduct(model.getSelectedEntity(jTable1.getSelectedRow()).getId());
        }
        model.updateData();
        ((AbstractTableModel) jTable1.getModel()).fireTableDataChanged();
